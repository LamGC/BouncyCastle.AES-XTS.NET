...
namespace LamGC.BouncyCastle.AES_XTS.Benchmarks;
...
public class AesXtsBenchmark
{
    ...
    // 2. 提供参数源
    public IEnumerable<AlgoConfig> AlgoConfigs()
    {
        // XTS-AES-128: Key1(16 bytes) + Key2(16 bytes) = 32 bytes
        yield return new AlgoConfig { Name = "AES-128", Keys = "a581d051ae57a097552491dd3fc480af28d059b084f2273c6ac0ef7a74d484cb" };
        
        // XTS-AES-256: Key1(32 bytes) + Key2(32 bytes) = 64 bytes
        yield return new AlgoConfig { Name = "AES-256", Keys = "ef010ca1a3663e32534349bc0bae62232a1573348568fb9ef41768a7674f507a727f98755397d0e0aa32f830338cc7a926c773f09e57b357cd156afbca46e1a0" };
    }
    ...
    public void Setup()
    {
        ...
        _cipher = new XtsAesBufferedCipher();
